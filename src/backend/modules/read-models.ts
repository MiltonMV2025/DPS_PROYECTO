...
export type InventoryListItem = { id: number; name: string; category: string; unit: string; currentStock: number; minimumStock: number; supplier: string | null; stockStatus: "ok" | "low" };

...
export type PatientListItem = { id: number; name: string; email: string; phone: string; birthDate: string; allergies: string | null; active: boolean };
export type InventoryListItem = { id: number; name: string; category: string; unit: string; currentStock: number; minimumStock: number; supplierId: number | null; supplier: string | null; stockStatus: "ok" | "low" | "out" };
